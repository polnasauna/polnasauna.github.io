(async function () {
  ...
  async function checkPayment() {
    try {
      ...
      if (data.gw_url) {
          msg.innerHTML = `Platba neprešla. Pre opätovné zaplatenie <a href="${data.gw_url}">kliknite tu</a>. Pre zrušenie platby <a href="cancel?code=${data.booking_id}">kliknite tu</a>.`;
      }
